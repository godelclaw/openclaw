...
function buildChatCommands(): ChatCommandDefinition[] {
  const commands: ChatCommandDefinition[] = [
    ...
    defineChatCommand({
      key: "mindlock",
      nativeName: "mindlock",
      description: "Mindlock menu and box views (in/out/pending/rejected).",
      textAlias: "/mindlock",
      acceptsArgs: true,
      args: [
        {
          name: "box",
          description: "Optional: in|out|pending|rejected",
          type: "string",
          required: false,
        },
        {
    ...
    defineChatCommand({
      key: "review",
      nativeName: "review",
      description: "List pending mindlock items awaiting Zar review.",
      textAlias: "/review",
      category: "management",
    }),
    defineChatCommand({
    ...
    defineChatCommand({
      key: "mindlock-approve",
      nativeName: "a",
      description: "Approve a pending mindlock item by artifact id or list index.",
      textAlias: "/a",
      acceptsArgs: true,
      args: [
        {
    ...
    defineChatCommand({
      key: "reject",
      nativeName: "reject",
      description: "Reject a pending mindlock item by artifact id or list index.",
      textAliases: ["/reject", "/r"],
      acceptsArgs: true,
      args: [
        {
          name: "artifact_id",
