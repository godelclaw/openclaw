...
import { buildChannelAccountSnapshot as buildChannelStatusAccountSnapshot } from "../channels/plugins/status.js";
...
export async function getHealthSnapshot(params?: {
  ...
  for (const plugin of listChannelPlugins()) {
    ...
    for (const accountId of accountIdsToProbe) {
      ...
      const snapshot = await buildChannelStatusAccountSnapshot({
        plugin,
        cfg,
        accountId,
        runtime,
